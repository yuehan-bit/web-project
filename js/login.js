function handleLogin(event) {
  ...
  const mockDatabase = {
    cadet: [
      ...
      { username: "23-3336", password: "02/22/2004", name: "Cadet John Mark" },
      {
        ...
        name: "Cadet Sarah Johnson",
      },
      {
        username: "24-1234",
        password: "cadet2024",
        name: "Cadet Michael Chen",
      },
      {
        username: "24-5678",
        password: "rotc2024",
        name: "Cadet Emma Rodriguez",
      },
  ...
  // Find user
  const user = mockDatabase[userType]?.find(
  ...
  if (user) {
    ...
    let usernameValid = mockDatabase[userType]?.some(
